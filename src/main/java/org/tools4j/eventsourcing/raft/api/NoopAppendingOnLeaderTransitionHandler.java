...
public class NoopAppendingOnLeaderTransitionHandler implements OnTransitionHandler {
    private final NoopEncoder noopEncoder = new NoopEncoder();
    private final MutableDirectBuffer encoderBuffer;
    private final MessageHeaderEncoder messageHeaderEncoder;

    public NoopAppendingOnLeaderTransitionHandler(final MutableDirectBuffer encoderBuffer,
